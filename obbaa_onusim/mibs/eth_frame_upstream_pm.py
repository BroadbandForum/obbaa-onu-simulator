...
""" Ethernet Frame Performance Monitoring History Data Upstream (G.988 9.3.30).
"""
...
#: Instantiated `MIB`.
eth_frame_upstream_pm_mib = MIB(322, 'ETH_FRAME_UPSTREAM_PM', 'Ethernet Frame Performance Monitoring History Data Upstream', attrs=(
